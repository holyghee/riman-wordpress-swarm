...
add_action('wp_enqueue_scripts', function () {
    ...
    wp_enqueue_style($handle);
    $css = '.wp-block-riman-breadcrumbs,.wp-block-shortcode .riman-breadcrumbs{width:100%;position:relative;z-index:25;pointer-events:auto;}
    .riman-breadcrumbs{font-size:.85rem;letter-spacing:.01em;color:#5a5f71;margin:0 auto clamp(2rem,3vw,3rem);padding:0 clamp(1rem,3vw,1.5rem) clamp(1rem,2vw,1.75rem);max-width:var(--wp--style--global--content-size, 1200px);background:transparent;}
    ...
    .riman-breadcrumbs__list{margin:0;padding:0;display:flex;flex-wrap:wrap;gap:.5rem;align-items:center;}
